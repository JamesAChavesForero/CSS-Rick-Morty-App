...
export default function Intro() {
  return (
    ...
    <section className='banner'>
      <h2>
        <small className="first">F</small>
        <small className="second">I</small>
        <small className="third">N</small>
        <small className="forth">D </small>
        <small className="fifth"> &</small>
      </h2>
      ...
      <span>
        Your Favorite Rick & Morty Characters at a the Press <a href="#search" className="realButton">
          <svg stroke="#ffffff" 
          xmlSpace="preserve" viewBox="0 0 80 80" 
          xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1"
           fill="#ffffff"><g strokeWidth="0" id="SVGRepo_bgCarrier"></g><g strokeLinejoin="round" strokeLinecap="round" 
           id="SVGRepo_tracerCarrier"></g><g id="SVGRepo_iconCarrier"> <g> 
