...
export default function Intro() {
  return (
    ...
    <section className='banner'>
      <h2>
        <small class="first">F</small>
        <small class="second">I</small>
        <small class="third">N</small>
        <small class="forth">D </small>
        <small class="fifth"> &</small>
      </h2>
      <div class="wrapper">
